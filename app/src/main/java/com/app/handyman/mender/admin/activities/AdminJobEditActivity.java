...
public class AdminJobEditActivity extends AppCompatActivity {


    private static final String TAG = AdminJobEditActivity.class.getSimpleName();
    ...
    private EditText txtDrivingHoursValue, txtWorkingHoursValue;
    private TextView  txtMaterialPurchasedValue;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                txtMaterialPurchasedValue.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(AdminJobEditActivity.this, AddMaterialPurchaseDetailsActivity.class);
                ...
                txtDrivingHoursValue.setText(request.getDriveTime());
                txtWorkingHoursValue.setText(request.getLabourTime());
                ...
                mRaiseDispute.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(AdminJobEditActivity.this, RaiseDisputeActivity.class);
                ...
                txtAddress.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!address.isEmpty()) {
                            ...
                            Toast.makeText(AdminJobEditActivity.this, "Not able to fetch address!", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        try {
                            ...
                            if (finalI == 1) {
                                ...
                                Glide.with(AdminJobEditActivity.this)
                            ...
                            final ImagePopup imagePopup = new ImagePopup(AdminJobEditActivity.this);
...
//        toolbar.setTitle("");
        ...
        txtDrivingHoursValue =  findViewById(R.id.txtDrivingHoursValue);
        ...
        txtWorkingHoursValue =  findViewById(R.id.txtWorkingHoursValue);
        ...
        toast = Toast.makeText(AdminJobEditActivity.this, "", Toast.LENGTH_SHORT);
        ...
        rvMaterialRecipt.setLayoutManager(new LinearLayoutManager(AdminJobEditActivity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initUI() {
        (findViewById(R.id.done_edit_request)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               /* Intent intent = new Intent(AdminJobEditActivity.this, AdminJobEditActivity.class);
    ...
    private void startJobConfirmation() {
        final Dialog dialog = new Dialog(AdminJobEditActivity.this);
    ...
    private void goToNextActivity() {
        Intent intent = new Intent(AdminJobEditActivity.this, StartJobActivity.class);
        intent.putExtra("id", jobId);
        startActivity(intent);
    }
    ...
    private void updateJobDetails(String key) {
        //txtDrivingHoursValue, txtWorkingHoursValue
        final String driving = txtDrivingHoursValue.getText().toString().trim();
        final String working = txtWorkingHoursValue.getText().toString().trim();

        System.out.println("key ::: " + key + " :::: name ::: " );

        if (TextUtils.isEmpty(driving)) {
            Toast.makeText(this, "Please enter Driving hours", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        DatabaseReference userRef = mRootRef.child("Requests").child(key);
        ...
        mRequest.setDriveTime(driving);
        mRequest.setLabourTime(working);
        f = mRequest.toFirebase();
        ...
        userRef.updateChildren(f, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                if (databaseError == null) {
                 /*   Intent intent = new Intent(AdminJobEditActivity.this, HomeActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);*/
                    Toast.makeText(AdminJobEditActivity.this, "Job details updated", Toast.LENGTH_SHORT).show();
                    finish();
                }else {
                    Toast.makeText(AdminJobEditActivity.this, "Job details not updated", Toast.LENGTH_SHORT).show();
